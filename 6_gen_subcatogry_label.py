...
def main():
    ...
    for pos_or_neg in tags:
        ...
        if pos_or_neg == 'n':
            ...
            temp=temp_p
        batch_size=300
        train_root = 'DATA/MIDOG2021/dataset_step2_k1=4/train/'+pos_or_neg+'/'
        infer_root=train_root
        savepath = 'DATA/MIDOG2021/dataset/train/final_k1='+str(cluster_k)+'_k2='+str(cluster_k_2)+'/'+pos_or_neg+'/'
